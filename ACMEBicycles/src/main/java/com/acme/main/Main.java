...
public class Main {
    ...
    private static void testReceipt() {
        ...
        ArrayList<AbstractBike> customeUpgrade = new ArrayList<>();
        ...
        bike.add(custom);
        customeUpgrade.add(custom);
        customeUpgrade.add(new GoldFrameOption(custom));

        accessoryList.add(0, new Accessories("Helmet", 29.99));


        new SampleReceipt(bike, customeUpgrade, accessoryList);
    }
